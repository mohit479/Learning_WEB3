...
var balanceButton = document.getElementById('getBallance');
...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(typeof window.ethereum !== "undefined" && ethAmount.value)) return [3 /*break*/, 5];
                ...
                case 2:
                    ...
                    return [4 /*yield*/, publicClient.simulateContract({
                            ...
                            abi: constants_ts_1.cofeeAbi,
                            functionName: "fund",
                            account: connectedAccount,
                            chain: currentChain,
                            value: (0, viem_1.parseEther)(ethAmount.value)
                        })];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    balance = _a.sent();
                    console.log("Contract Balance:", (0, viem_1.formatEther)(balance));
                    _a.label = 2;
